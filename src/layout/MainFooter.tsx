    ...
    >
      ...
      >
        <Box sx={{ display: 'grid', gap: 1.5 }}>
          <Box component="h3" sx={{ ...typeStyles.h3, fontSize: '1.35rem', color: 'brand.nude' }}>
            {SITE_CONFIG.name}
          </Box>
          <Box component="p" sx={{ ...typeStyles.body2, maxWidth: 320, color: 'brand.beige' }}>
            Medicina estética con criterio médico, resultados naturales y seguimiento personalizado.
          </Box>
        </Box>

        <Box sx={{ display: 'grid', gap: 1.1 }}>
          <Box component="strong" sx={{ color: 'brand.nude', fontSize: { xs: '0.98rem', md: '0.95rem' } }}>
            Contacto
          </Box>
          <Box
            component={Link}
            ...
            sx={{
              ...
              '&:hover': { color: 'brand.nude' },
            }}
          >
            WhatsApp: {SITE_CONFIG.contact.phone}
          </Box>
          <Box component="span" sx={{ ...typeStyles.body2, color: 'brand.beige', fontSize: { xs: '1rem', md: '0.98rem' } }}>
